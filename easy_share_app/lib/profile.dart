...
class _ProfilePageState extends State<ProfilePage> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            GestureDetector(
              ...
              child: Stack(
                ...
                children: [
                  CircleAvatar(
                    radius: 50,
                    backgroundColor: Colors.grey[800], // Black Circle Background
                  ...
                  const CircleAvatar(
                    radius: 16,
                    backgroundColor: Colors.black, // Black Camera Icon Background
                    child: Icon(Icons.camera_alt, color: Colors.white, size: 18), // White Camera Icon
                  ),
                ],
              ),
            ),
            ...
            Text(phoneNumber, style: const TextStyle(fontSize: 16, color: Colors.white70)),

            const SizedBox(height: 30),

            // Profile Options
            _buildProfileOption(Icons.person, "Personal Details", context, isPersonal: true),
  ...
  Widget _buildProfileOption(IconData icon, String title, BuildContext context, {bool isLogout = false, bool isPersonal = false}) {
